...
CommonKeybinds.binds = {
    ...
    -- BindManager alt-binds.Blodykiller.all (while a partner is logged in)
    ...
    { key = "^numpad*", command = "sm follow off; gab sm follow off", raw = true, override = true, desc = "Gabvanstronger: sm follow off; gab sm follow off", alt = {name = "Gabvanstronger"} },
    { key = "^numpad/", command = "blody sm follow blodykiller; gab sm follow blodykiller;", raw = true, override = true, desc = "Gabvanstronger: blody sm follow blodykiller; gab sm foll", alt = {name = "Gabvanstronger"} },
}

---============================================================================
--- BRD State Configuration - Blodykiller
---============================================================================
...
--- SubSet states), his instruments, his 'Gab' song pack as default and his
--- default idle (his 'Normal' idle is our Refresh set).
---
--- Features:
...
function BRDStates.configure()
    ...
    state.SongMode =
        ...
        'Gab', -- Honor + Min5/4 + STR Etude + Min3 (his "buffs" command)
    ...
    state.SongMode:set('Gab')

    -- Every value needs sets.midcast.Songs[<value>].range (brd_sets.lua).
    -- Loughnashade is not listed: Aria of Passion locks it on its own.
    state.MainInstrument =
        M {
        ['description'] = 'Main Instrument',
        'Gjallarhorn', -- REMA horn (best)
        'Daurdabla', -- his ExtraSongsMode 'FullLength'
        'Marsyas', -- Alternative horn
        'Miracle Cheer' -- his MiracleCheer toggle
    }
    ...
    state.SubWeapon:set('Ammurapi Shield')

...
---   - Hachirin-no-Obi on matching day/weather
...
---   ├── sets/blm/blm_sets.lua          [Equipment Sets - Modular]
...
--- GearSwap entry hook: loads Mote-Include, the shared systems and the BLM modules.

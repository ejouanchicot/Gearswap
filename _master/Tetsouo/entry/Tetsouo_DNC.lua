...
---   ├── sets/dnc/dnc_sets.lua              [Equipment Sets - Modular]
...
function user_setup()
    ...
    if success and keybinds then
        ...
        if ok and MessageFormatter then
            MessageFormatter.show_error('[DNC] Keybinds failed to load: ' .. tostring(keybinds))
        end
    end

---============================================================================
--- SMN (Summoner) - your own modes and gear rules
---============================================================================
...
return {
    ...
    -- Idle with an avatar out
    -- { when = { pet = true }, idle = { body = "Beck. Doublet +3" } },

    -- Low MP: refresh piece when idle
    -- { when = { mp_below = 50 }, idle = { waist = "Fucho-no-Obi" } },

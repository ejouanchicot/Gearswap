...
---   • Weapon selection (MainWeapon: 7 options, SubWeapon: 4 options)
...
---
--- @file    Tetsouo/config/thf/THF_STATES.lua
--- @author  Tetsouo
--- @version 1.0
...
function THFStates.configure()
    ...
    state.SubWeapon = M {
        ...
        'Telop Knife',  -- PDL dagger offhand
    ...
    -- REQUIRED by are_states_ready() (shared/utils/ui/ui_lifecycle.lua) for THF

...
---
--- Features:
---   • Modular architecture (11 hook modules + 1 logic module)
...
---
--- Architecture:
---   Main File >> whm_functions.lua (facade) >> 11 Hooks + Logic Module
---
--- Modules:
...
--- GearSwap entry hook: loads Mote-Include, the shared systems and the WHM modules.
...
function user_setup()
    ...
    if success and keybinds then
        ...
        if ok and MessageFormatter then
            MessageFormatter.show_error('[WHM] Keybinds failed to load: ' .. tostring(keybinds))
        end
    end

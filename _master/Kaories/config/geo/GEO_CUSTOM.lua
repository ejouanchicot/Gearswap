---============================================================================
--- GEO (Geomancer) - your own modes and gear rules
---============================================================================
...
return {
    ...
    -- Idle with a luopan out
    -- { when = { pet = true }, idle = { hands = "Geo. Mitaines +3" } },

    -- Indi- spells under Entrust (on someone else)
    -- { when = { spell = 'Indi-*', buff = 'Entrust' }, midcast = { main = "Solstice" } },

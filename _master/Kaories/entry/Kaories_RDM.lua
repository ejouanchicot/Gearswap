...
--- GearSwap entry hook: loads Mote-Include, the shared systems and the RDM modules.
...
function user_setup()
    ...
    if success and keybinds then
        ...
        if ok and MessageFormatter then
            MessageFormatter.show_error('[RDM] Keybinds failed to load: ' .. tostring(keybinds))
        end
    end

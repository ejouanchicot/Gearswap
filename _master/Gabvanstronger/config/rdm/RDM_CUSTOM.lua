---============================================================================
--- RDM (Red Mage) - your own modes and gear rules - Gabvanstronger
---============================================================================
...
return {
    ...
    -- Capacity Point cape, from his gear file (CAPACITY.Cape in his
    -- 0_AugGear_Gabvanstronger.lua; his old 0_AutoCP.lua put it on by itself,
    -- but his RDM file did not load it). While On, the cape goes on and the
    -- back slot stays locked. No key in his binds for it: //gs c cyclestate CP
    -- (add key = '...' here to bind one).
    {
        state  = 'CP',
        desc   = 'CP Cape',
        values = 'onoff',
        On     = {
            all  = { back = { name="Mecisto. Mantle", augments={'Cap. Point+50%','STR+2','"Mag.Atk.Bns."+4','DEF+2',}} },
            lock = {'back'},
        },
    },

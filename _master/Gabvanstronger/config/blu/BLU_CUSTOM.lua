---============================================================================
--- BLU (Blue Mage) - your own modes and gear rules - Gabvanstronger
---============================================================================
...
return {
    ...
    -- Pull: his check_rangedset equipped sets.Pull (Albin Bane) and locked
    -- range + ammo. Normal: the slots free again, nothing equipped (his
    -- check_rangedset equipped {range = 'Normal'}, which is no item).
    {
        state   = 'RangedSet',
        desc    = 'Ranged Weapon',
        key     = '@`',
    ...
    -- Capacity Point cape (sets.CP = CAPACITY.Cape). His BLU had the CP state
    ...
    -- His customize_idle_set meant to add sets.latent_refresh (Fucho-no-Obi)
    -- under 51% MP, but threw the result away: it never went on. Remove the
    -- "--" to have it.
    -- { when = { mp_below = 51 }, idle = 'sets.latent_refresh' },

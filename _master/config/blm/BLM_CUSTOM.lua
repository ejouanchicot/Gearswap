---============================================================================
--- BLM (Black Mage) - your own modes and gear rules
---============================================================================
...
---        key     = '^numpad.',            ^ Ctrl  ! Alt  @ Win  # Apps  ~ Shift
...
return {
    ...
    -- Obi when the day or weather matches the spell
    -- { when = { skill = 'Elemental Magic', day_weather = true }, midcast = { waist = "Hachirin-no-Obi" } },

    -- Orpheus when close to the target
    -- { when = { skill = 'Elemental Magic', distance_below = 6 }, midcast = { waist = "Orpheus's Sash" } },

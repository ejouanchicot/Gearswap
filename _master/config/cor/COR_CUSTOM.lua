---============================================================================
--- COR (Corsair) - your own modes and gear rules
---============================================================================
...
return {
    ...
    -- Phantom Roll (Luzaf's Ring is left alone)
    -- { when = { spell_type = 'CorsairRoll' }, ability = { head = "Lanun Tricorne +3" } },

    -- Quick Draw on a matching day or weather: Obi
    -- { when = { spell_type = 'CorsairShot', day_weather = true }, ability = { waist = "Hachirin-no-Obi" } },

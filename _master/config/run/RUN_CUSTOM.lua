---============================================================================
--- RUN (Rune Fencer) - your own modes and gear rules
---============================================================================
...
return {
    ...
    -- Phalanx on yourself
    -- { when = { spell = 'Phalanx', target = 'self' }, midcast = { head = "Fu. Bandeau +3" } },

    -- Low HP while tanking
    -- { when = { hp_below = 40 }, engaged = { ring2 = "Moonlight Ring" } },

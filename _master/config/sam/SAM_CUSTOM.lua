---============================================================================
--- SAM (Samurai) - your own modes and gear rules
---============================================================================
...
return {
    ...
    -- Weaponskills under Meikyo Shisui
    -- { when = { buff = 'Meikyo Shisui' }, weaponskill = { feet = "Sakonji Sune-Ate +3" } },

    -- Low TP weaponskill: Moonshade
    -- { when = { tp_below = 2000 }, weaponskill = { ear1 = "Moonshade Earring" } },

---============================================================================
--- RDM (Red Mage) - your own modes and gear rules
---============================================================================
...
return {
    ...
    -- Enfeebles under Saboteur
    -- { when = { skill = 'Enfeebling Magic', buff = 'Saboteur' }, midcast = { hands = "Leth. Ganth. +3" } },

    -- Enhancing on others under Composure
    -- { when = { skill = 'Enhancing Magic', buff = 'Composure', target = 'other' }, midcast = { head = "Leth. Chappel +3" } },

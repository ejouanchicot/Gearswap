---============================================================================
--- BLU (Blue Mage) - your own modes and gear rules
---============================================================================
...
return {
    ...
    -- MP under 51%: a latent Refresh belt when idle
    -- { when = { mp_below = 51 }, idle = { waist = "Fucho-no-Obi" } },

    -- Chain Affinity up: Blue Magic that lands after it
    -- { when = { buff = 'Chain Affinity', skill = 'Blue Magic' }, midcast = { head = "Hashishin Kavuk +3" } },

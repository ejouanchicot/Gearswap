---============================================================================
--- THF (Thief) - your own modes and gear rules
---============================================================================
...
return {
    ...
    -- Weaponskills with Sneak Attack up
    -- { when = { buff = 'Sneak Attack' }, weaponskill = { hands = "Skulk. Armlets +3" } },

    -- Aftermath Lv.3 with Vajra
    -- { when = { buff = 'Aftermath: Lv.3', weapon = 'Vajra' }, engaged = { ring1 = "Chirich Ring +1" } },

...
M.commands = {
    ...
    poisonga       = { action = 'ma', target = 'lastst', desc = 'Poisonga',
                       tiers = { { spell = 'Poisonga II', level = 64 }, { spell = 'Poisonga', level = 24 } } },
    ...
    virus          = { action = 'ma', target = 'lastst', desc = 'Virus',
                       tiers = { { spell = 'Virus', level = 1 } } },
    ...
    curse          = { action = 'ma', target = 'lastst', desc = 'Curse',
                       tiers = { { spell = 'Curse', level = 1 } } },
    ...
    meteor         = { action = 'ma', target = 'lastst', desc = 'Meteor',
                       tiers = { { spell = 'Meteor', level = 99 }, { spell = 'Meteor II', level = 75 } } },

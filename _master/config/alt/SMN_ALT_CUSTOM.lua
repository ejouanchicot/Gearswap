...
M.commands = {
    ...
    -- Targeting comes from res; the levels were checked against BG-Wiki's
    -- Summoner page - fix them here if the game disagrees, nothing
    ...
    elementalsiphon = { action = 'ja',  spell = 'Elemental Siphon', target = 'me', level = 50, group = 'ja', desc = 'Drain MP from the summoned spirit' },
    ...
    apogee          = { action = 'ja',  spell = 'Apogee',           target = 'me', level = 70, main_only = true, group = 'ja', desc = 'Next Blood Pact: Rage hits harder' },

    -- Pet commands: no avatar out, nothing happens.
    avatarsfavor    = { action = 'pet', spell = "Avatar's Favor",   target = 'me', level = 55, main_only = true, group = 'ja', desc = 'Aura from the avatar, grows while it stays out' },

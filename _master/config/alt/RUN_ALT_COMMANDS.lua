...
M.commands = {
    ...
    gelus            = { action = 'ja', spell = 'Gelus',                  target = 'me', level = 5, group = 'ja', desc = 'Ice rune, resist wind' },
    ...
    tellus           = { action = 'ja', spell = 'Tellus',                 target = 'me', level = 5, group = 'ja', desc = 'Earth rune, resist lightning' },
    tenebrae         = { action = 'ja', spell = 'Tenebrae',               target = 'me', level = 5, group = 'ja', desc = 'Dark rune, resist light' },
    unda             = { action = 'ja', spell = 'Unda',                   target = 'me', level = 5, group = 'ja', desc = 'Water rune, resist fire' },

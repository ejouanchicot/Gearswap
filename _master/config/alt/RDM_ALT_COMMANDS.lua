...
---
--- GENERATED - do not edit. Put your changes in RDM_ALT_CUSTOM.lua, which is
...
M.commands = {
    ...
    -- JOB ABILITIES
    -- ========================================================================
    chainspell       = { action = 'ja', spell = 'Chainspell',             target = 'me', level = 1, main_only = true, group = 'ja', desc = 'Rapid spellcasting' },
    composure        = { action = 'ja', spell = 'Composure',              target = 'me', level = 50, main_only = true, group = 'ja', desc = 'Self-enhancing x3 duration, ACC+' },
    convert          = { action = 'ja', spell = 'Convert',                target = 'me', level = 40, group = 'ja', desc = 'Swap HP with MP' },
    saboteur         = { action = 'ja', spell = 'Saboteur',               target = 'me', level = 83, main_only = true, group = 'ja', desc = 'Enfeebling potency/duration x2' },
    spontaneity      = { action = 'ja', spell = 'Spontaneity',            target = 'lastst', level = 95, main_only = true, group = 'ja', desc = 'Next spell instant cast' },
    stymie           = { action = 'ja', spell = 'Stymie',                 target = 'me', level = 96, main_only = true, group = 'ja', desc = 'Next enfeebling 100% MACC' },

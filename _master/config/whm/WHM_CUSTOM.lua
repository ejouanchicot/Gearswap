---============================================================================
--- WHM (White Mage) - your own modes and gear rules
---============================================================================
...
return {
    ...
    -- Cures on a matching day or weather: Obi
    -- { when = { spell = 'Cure*', day_weather = true }, midcast = { waist = "Hachirin-no-Obi" } },

    -- Cures under Afflatus Solace
    -- { when = { spell = 'Cure*', buff = 'Afflatus Solace' }, midcast = { body = "Ebers Bliaut +3" } },

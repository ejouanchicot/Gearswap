---============================================================================
--- PLD (Paladin) - your own modes and gear rules
---============================================================================
...
return {
    ...
    -- Cures on yourself
    -- { when = { spell = 'Cure*', target = 'self' }, midcast = { waist = "Sroda Belt" } },

    -- Phalanx on yourself
    -- { when = { spell = 'Phalanx', target = 'self' }, midcast = { hands = "Souv. Handsch. +1" } },

---============================================================================
--- DNC (Dancer) - your own modes and gear rules
---============================================================================
...
return {
    ...
    -- Saber Dance up
    -- { when = { buff = 'Saber Dance' }, engaged = { legs = "Horos Tights +3" } },

    -- Weaponskills under Climactic Flourish
    -- { when = { buff = 'Climactic Flourish' }, weaponskill = { head = "Maculele Tiara +3" } },

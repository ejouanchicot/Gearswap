...
---
---   @file    shared/data/job_abilities/PUP_JA_DATABASE.lua
---   @author  Tetsouo
...
-- that meant the maneuvers, Deploy, Retrieve and Deactivate never had a job ability message.
return Factory.create('PUP', {
    modules = {'subjob', 'mainjob', 'sp', 'pet_commands_subjob'}
})

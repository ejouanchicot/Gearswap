...
---
---   @file    shared/jobs/pld/functions/PLD_LOCKSTYLE.lua
---   @author  Tetsouo
...
--- @return any Result of the factory's select_default_lockstyle()
...
--- @return any Result of the factory's cancel function

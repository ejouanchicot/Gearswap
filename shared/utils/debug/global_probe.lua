...
local EXPECTED = {
    ...
    CORTPConfig = true, CastStorm = true, CraftManager = true,
    DETECTED_FFXI_REGION = true,
    DISABLE_AUTOMOVE = true, DNCTPConfig = true, DNCWSConfig = true,
    DRESSUP_MANAGEMENT_ENABLED = true,
    ...
    JobChangeManagerSTATE = true, KeybindGuard = true, KeybindUI = true,
    LagDebugger = true,
